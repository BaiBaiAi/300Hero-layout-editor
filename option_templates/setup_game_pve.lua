...
function InitMainSetup_GameA(wnd)
    ...
    local posx = {328, 328, 328, 328, 490, 490, 490, 490, 655, 620, 620, 605, 812, 812, 313, 475, 620, 812, 900, 812, 328}--, 460}
    local posy = {419, 455, 491, 527, 419, 455, 491, 527, 419, 455, 491, 527, 419, 455, 558, 558, 558, 558, 527, 527, 589}--, 589}
...
function InitGameSetUiCheckButton(cCheck1, cCheck2, cCheck3, cCheck4, cCheck5, cCheck6, cCheck7, cCheck8, cCheck9,
    cCheck10, cCheck11, cCheck12, cCheck13, cCheck14, cCheck15, cCheck16, cCheck17, cCheck18, cCheck19, cCheck20,
    cCheck21, cCheck22, cCheck23, cCheck24, cCheck25)
    ...
    check_pattern[14]:SetVisible(cCheck14)
    check_pattern[15]:SetVisible(cCheck15)
    check_pattern[16]:SetVisible(cCheck16)
    check_pattern[17]:SetVisible(cCheck17)
    check_pattern[18]:SetVisible(cCheck18)
    check_pattern[19]:SetVisible(cCheck19)
    check_pattern[20]:SetVisible(cCheck20)
    check_pattern[21]:SetVisible(cCheck21)
    check_pattern[22]:SetVisible(cCheck22)
    check_pattern[23]:SetVisible(cCheck23)
    check_pattern[24]:SetVisible(cCheck24)
	check_pattern[25]:SetVisible(cCheck25)
end
